...
#...............................................................................
  ...
  ## Predict under 5 proportion for all districts and biennia
    ...
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_u5prop_pred.png", sep =""),
...
#...............................................................................
  ...
  ## Compute mean, median and 95% percentile estimates: by district-month
    ...
    # Save best estimates as output for computing predictor rate values
      ...
      pop_best <- pop_dis[, c("district", "tm", "y", "m", "pop_mean","pop_025","pop_975",
        "pop_u5_mean", "pop_u5_025", "pop_u5_975", "pop_u5_alt_mean", "prop_idp_mean", "dep_rate_mean", 
        "arr_rate_mean")] 
      colnames(pop_best) <- gsub("_mean", "", colnames(pop_best))
      colnames(pop_best) <- gsub("_025", "_low", colnames(pop_best))
      colnames(pop_best) <- gsub("_975", "_upp", colnames(pop_best))
      
      # round
      pop_best[, c("pop", "pop_u5", "pop_low", "pop_u5_low", "pop_upp", "pop_u5_upp",  "pop_u5_alt")] <- 
        round(pop_best[, c("pop", "pop_u5", "pop_low", "pop_u5_low", "pop_upp", "pop_u5_upp",  "pop_u5_alt")], 0)
    ...
    pop_cedf <- aggregate(pop[, c("pop", "pop_u5", "pop_u5_alt")], 
                          by = pop[, c("region", "district")], 
                          FUN = function(x) {ecdf(x[is.finite(x)])})
    
    saveRDS(pop_cedf, file = paste(dir_path, "/output/som_out_pop_cedfs_district.rds", 
      sep =""), compress = TRUE)
  ...
  ## Visualise evolution of total population
    ...
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_evol_region.png", sep =""),
    ...
    plot <- ggplot(data = pop_nat, aes(x = date, y = pop_mean)) +
      ...
      scale_y_continuous("estimated population", labels = label_comma()) +
      theme_bw()
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_evol_country.png", sep =""),
      dpi = "print", units = "cm", height = 13, width = 20)    
  ...
  ## Visualise evolution of the proportion of IDPs
    ...
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_evol_prop_idp_region.png", 
    ...
    plot <- ggplot(data = pop_nat, aes(x = date, y = prop_idp_mean)) +
      ...
      scale_y_continuous("estimated percentage of IDPs out of total population",
        labels = label_percent()) +
      theme_bw()
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_evol_prop_idp_country.png",
