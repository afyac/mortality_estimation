...
#...............................................................................
  ...
  ## Visualise output
    ...
    # Which parameter values are mostly associated with implausible output?
      ...
      ggsave(paste(dir_path, "/visualisation/output/som_out_pop_implausible_pop_runs.png", 
      ...
      plot2 <- ggplot(data = out, aes(x = prop_stay, y = ret_time, 
        ...
        facet_grid(stratum ~ pop_source, 
          labeller = labeller(pop_source = pop_labels))
      ggsave(paste(dir_path,"/visualisation/output/som_out_pop_implausible_prop_idp_runs.png", 
        sep =""), dpi = "print", units = "cm", height = 20, width = 30)
      
      # combined plot
      plot <- ggarrange(plot1, plot2, nrow = 2, hjust = -0.1, labels = 
        c("Negative population", "IDPs < 0% or > 100% of total population") )
      ggsave(paste(dir_path,"/visualisation/output/som_out_pop_implausible_runs_combi.png", 
  ...
  for (i in c("rmse", "negll", "negll_pen")) {
    ...
    for (j in pop_sources$worksheet) {
      ...
      # save plot
      plot <- x$plot
      ggsave(paste(dir_path, "/visualisation/output/som_out_pop_profs_", j, "_", i, 
  ...
  ## Smooth likelihood surfaces for each stratum and population source
    ...
    write.csv(out_smooth, 
      paste(dir_path, "visualisation/output/som_pop_out_smooth.csv", sep = ""), 
      row.names = FALSE)
    ...
    ggsave(paste(dir_path, "/visualisation/output/som_out_pop_smooth_surfs.png", sep =""),
  ...
  ## Compute best estimates of the unknown parameters
    ...
    flextable::save_as_docx(x, 
      path = paste(dir_path, "visualisation/output/som_out_pop_par_est.docx", sep=""))
